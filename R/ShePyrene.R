...
#'
#' @usage data(ShePyrene)
#' @aliases ShePyrene
#'
#' @docType data
#' @keywords dataset
#' @name ShePyrene
#' @source She, N., 1997, Analyzing censored water quality data using a nonparametric approach.  Journal of the American Water Resources Association, 33, pp615--624.
#' @references
